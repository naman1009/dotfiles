...
globalkeys = gears.table.join(
    awful.key({modkey , "Mod1"}, 's', function() awful.util.spawn("systemctl suspend")end),
    ...
    awful.key({ modkey,           }, "w", function () awful.util.spawn_with_shell("nitrogen --random --set-scaled ~/wallpaper") end,
    ...
    awful.key({modkey, "Shift"}, "p", function() awful.util.spawn_with_shell("rofi -show run")end ),
...
clientkeys = gears.table.join( 
    awful.key({modkey, "Shift", "Mod1"}, "s", function() awful.util.spawn_with_shell("setxkbmap -option caps:swapescape")end ),
...
clientbuttons = gears.table.join(
    ...
    awful.key({ modkey, "Alt"    }, "Left",     function () awful.tag.incmwfact(-0.01)    end),
    awful.key({ modkey, "Alt"    }, "Down",     function () awful.client.incwfact( 0.01)    end),
    awful.key({ modkey, "Alt"    }, "Up",     function () awful.client.incwfact(-0.01)    end)
...
awful.util.spawn_with_shell("~/.config/awesome/nitrogen.sh")
